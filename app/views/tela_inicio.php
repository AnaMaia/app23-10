...
<div class="ui large top fixed hidden menu borderless">
    <div class="ui container">
        ...
        <a  href="tela_inicio.php" class="item">O que fazemos</a>
        <a href="tela_sobre.php" class="item">Sobre</a>

        <div class="right item" >
            <a href="login.php" style="background-color: black" class="ui inverted button">Entrar</a>
        </div>
    </div>
</div>
...
<!-- Page Contents -->
<div class="pusher">
  <div class="ui inverted vertical masthead center aligned segment" style="height: 828px">
    ...
    <div class="ui text container">
        <img src="../../assets/images/mao.png" class="image" style="width: 170px; margin-top: 30px" >

        <h1 class="ui inverted header" style="font-family: Steiner; margin-top: 0px"  >
        Estoque do Infinito
      </h1>
